        ...
        <>
            <Card className="stats-card mb-6 p-4">
                <div className="flex flex-col sm:flex-row gap-3 items-end">
                    ...
                    <Button variant="secondary" className="gap-1.5" onClick={handleFiltering}>
            ...
            <DatePickerDialog
                ...
                onDateChange={(value) => setFilters({ ...filters, startDate: value?.toLocaleDateString('en-CA') })}
            />
            ...
            <DatePickerDialog
                ...
                onDateChange={(value) => { setFilters({ ...filters, endDate: value?.toLocaleDateString("en-CA") }) }
                }
            />
        </>
    )
